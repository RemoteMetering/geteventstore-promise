...
export default (subscription, { onEventAppeared, onDropped, includeDeleted, debug }) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    subscription.once('confirmation', () => {
      confirmed = true;
      const ackFiltered = (resolvedEvent) => originalAck.call(subscription, resolvedEvent);
      wireHandlers(subscription, onEventAppeared, reportDropped, includeDeleted, ackFiltered);
