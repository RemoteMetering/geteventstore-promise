...
export const mapEvent = (ev) => {
  ...
  if (!event) {
    ...
    if (ev.commitPosition !== undefined) deletedEvent.commitPosition = ev.commitPosition;
  ...
  if (ev.commitPosition !== undefined) mappedEvent.commitPosition = ev.commitPosition;
