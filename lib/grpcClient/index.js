...
import subscribeToPersistentSubscriptionToAll from './subscribeToPersistentSubscriptionToAll.js';
import createPersistentSubscriptionToStream from './createPersistentSubscriptionToStream.js';
import createPersistentSubscriptionToAll from './createPersistentSubscriptionToAll.js';
...
import iterateReadEvents, { iterateReadEventsWithState } from './iterateReadEvents.js';
import readEvents from './readEvents.js';
import readStreamEvents from './readStreamEvents.js';
...
import persistentSubscriptionAssertToAll from './persistentSubscriptions/assertToAll.js';
import persistentSubscriptionRemove from './persistentSubscriptions/remove.js';
import persistentSubscriptionRemoveToAll from './persistentSubscriptions/removeToAll.js';
import persistentSubscriptionGetToAllSubscriptionInfo from './persistentSubscriptions/getToAllSubscriptionInfo.js';
import persistentSubscriptionGetToAllSubscriptionsInfo from './persistentSubscriptions/getToAllSubscriptionsInfo.js';
import persistentSubscriptionRestartSubsystem from './persistentSubscriptions/restartSubsystem.js';
import persistentSubscriptionReplayParkedMessagesToStream from './persistentSubscriptions/replayParkedMessagesToStream.js';
import persistentSubscriptionReplayParkedMessagesToAll from './persistentSubscriptions/replayParkedMessagesToAll.js';
...
export default class GRPCClient {
  constructor(config) {
    ...
    this.readEventsForward = readStreamEvents(iterateReadEventsWithState(_config, 'forward'), 'forward');
    this.readEventsBackward = readStreamEvents(iterateReadEventsWithState(_config, 'backward'), 'backward');
    ...
    this.createPersistentSubscriptionToAll = createPersistentSubscriptionToAll(_config);
    this.subscribeToPersistentSubscriptionToStream = subscribeToPersistentSubscriptionToStream(_config);
    this.subscribeToPersistentSubscriptionToAll = subscribeToPersistentSubscriptionToAll(_config);
    this.projections = {
      ...
      restartSubsystem: projectionRestartSubsystem(_config)
    };
    this.persistentSubscriptions = {
      assert: persistentSubscriptionAssert(_config),
      assertToAll: persistentSubscriptionAssertToAll(_config),
      remove: persistentSubscriptionRemove(_config),
      removeToAll: persistentSubscriptionRemoveToAll(_config),
      getSubscriptionInfo: persistentSubscriptionGetSubscriptionInfo(_config),
      getToAllSubscriptionInfo: persistentSubscriptionGetToAllSubscriptionInfo(_config),
      getAllSubscriptionsInfo: persistentSubscriptionGetAllSubscriptionsInfo(_config),
      getToAllSubscriptionsInfo: persistentSubscriptionGetToAllSubscriptionsInfo(_config),
      getStreamSubscriptionsInfo: persistentSubscriptionGetStreamSubscriptionsInfo(_config),
      replayParkedMessagesToStream: persistentSubscriptionReplayParkedMessagesToStream(_config),
      replayParkedMessagesToAll: persistentSubscriptionReplayParkedMessagesToAll(_config),
      restartSubsystem: persistentSubscriptionRestartSubsystem(_config)
    };
