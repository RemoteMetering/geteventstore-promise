...
import getCallerFile from './utilities/getCallerFile';
...
export default class TCPClient {
	constructor(config) {
		...
		if (config.generateConnectionName) assert(typeof config.generateConnectionName === 'function', `${baseErr}generateConnectionName must be a function`);
		...
		if (config.generateConnectionName) _config.generateConnectionName = () => config.generateConnectionName(getCallerFile());
