...
export default class TCPClient {
	constructor(config) {
		...
		this.getEventsByType = require('./getEventsByType')(_config);
		this.deleteStream = require('./deleteStream')(_config);
		this.eventEnumerator = require('./eventEnumerator')(_config);
		this.subscribeToStream = require('./subscribeToStream')(_config);
		this.subscribeToStreamFrom = require('./subscribeToStreamFrom')(_config);
		this.close = require('./connectionManager').close(_config);
		this.getPool = require('./connectionManager').getPool(_config);
		this.closeAllPools = require('./connectionManager').closeAllPools;
	}
}