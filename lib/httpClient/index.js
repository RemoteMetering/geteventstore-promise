...
export default class HTTPClient {
	constructor(config) {
		...
		const _checkStreamExists = checkStreamExists(_config);
		const _getEvents = getEvents(_config);
		...
		this.checkStreamExists = _checkStreamExists;
		this.writeEvent = writeEvent(_config);
		this.writeEvents = writeEvents(_config);
		this.getAllStreamEvents = getAllStreamEvents(_config);
		this.getEvents = _getEvents;
		this.getEventsByType = getEventsByType(_getEvents);
		this.deleteStream = deleteStream(_config, _checkStreamExists);
